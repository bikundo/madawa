...
<div class="page-header">
	<h3>
		...
		<div class="pull-right">
			<a href="{{ route('create/user') }}" class="btn btn-small btn-info"><i class="icon-plus-sign icon-white"></i>New User</a>
		</div>
	</h3>
</div>
...
<table class="table table-bordered table-striped table-hover">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<a href="{{ route('update/user', $user->id) }}" class="btn btn-mini btn-primary">@lang('button.edit')</a>
